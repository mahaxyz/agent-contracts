...
//   // (PoolKey memory poolKey, bool isToken0) = _createPool(address(p.fundingToken), address(token),
//   // p.initialSqrtPrice);
...
// function _addLiquidityToRange(PoolKey memory poolKey, bool isToken0, int24 tickLower, int24 tickUpper, uint256
// amount)
//   private
//   returns (uint128)
// {
