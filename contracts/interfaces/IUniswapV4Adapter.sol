...
interface IUniswapV4Adapter {
  ...
  function initialize(address _launchpad, address _poolManager, address _positionManager, address _swapRouter, address _permit2, address _WETH9) external;

  /// @notice Returns the pool key for a given token
